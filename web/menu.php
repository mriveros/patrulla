<?php
    ...
    $conectate=pg_connect("host=localhost port=5432 dbname=diablo user=postgres password=postgres")or die ('Error al conectar a la base de datos');
...
<body>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-header">
                ...
                <img src="http://dev.appwebpy.com/diablo/img/gama_fiesta.png" width=500 height=80 alt="Obra de K. Haring"> 
            </div>
            <center><a class="navbar-brand" href="#"><h2>Sistema de Servidor de Eventos- Diablo</h2></a></center>
            <!-- /.navbar-header -->
            <br><br>
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="http://localhost/diablo/web/logout.php"><i class="fa fa-sign-out fa-fw"></i> Cerrar Sesion</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="http://localhost/diablo/web/menu.php" value="Load new document" onclick="location.reload();"><i class="fa  fa-tasks"></i> Menu Principal</a>
                        </li>
			<li>
                            <a href="#"><i class="fa fa-user"></i> USUARIOS<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://localhost/diablo/web/usuarios/ABMusuario.php">Registros de Usuarios</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
			<li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://localhost/diablo/web/reservas/ABMreserva.php"> Registros de Reservas</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://localhost/diablo/web/eventos/ABMevento.php">Registros de Eventos</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://localhost/diablo/web/galerias/ABMgaleria.php">Registros de Imágenes</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://localhost/diablo/web/productos/ABMproducto.php">Registros Productos</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="http://localhost/diablo/web/informes/frmResumenReservas.php">Resumen Reservas</a>
                                </li>
                                <li>
                                    <a href="http://localhost/diablo/web/informes/frmResumenRechazados.php">Resumen no Aceptados</a>
                                </li>
