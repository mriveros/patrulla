...
$conectate=pg_connect("host=localhost port=5432 dbname='Diablo' user='postgres' password='2016aws.Postgres.ubuntu'")or die ('Error al conectar a la base de datos');
